...
[![CI](https://github.com/TheZavitaev/zakupator/actions/workflows/ci.yml/badge.svg)](https://github.com/TheZavitaev/zakupator/actions/workflows/ci.yml)
...
Telegram long-polling (aiogram 3)
            ↓
        bot/           ← handlers, форматтеры, inline keyboards
            ↓
...
4. Добавить лейблы/ссылки в `_SERVICE_LABELS` / `_SERVICE_HOME` / `_SERVICE_CART_LINKS` в `bot/presentation.py`
